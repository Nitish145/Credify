...
class BankDetailScreen2 extends StatefulWidget {
  ...
  const BankDetailScreen2({Key key, this.bankName}) : super(key: key);
                      ...
                      Padding(
                        ...
                        child: TextFormField(
                            ...
                            validator: (_accountNumber) {
                              bool isAccountValid;
                              if (_accountNumber.length <= 18 &&
                                  _accountNumber.length >= 9) {
                                isAccountValid = true;
                              }
                            ...
                            onPressed: () async {
                              ...
                              if (formKey.currentState.validate()) {
                                if (accountType != "Account Type") {
                                  ...
                                  bankDetailsResponse = await addBankData(
...
//                                                StatementUploadScreen()));
                                    ...
                                    Fluttertoast.showToast(
                                      msg:
                                          "Something Wrong Occured! Please check your internet connection",
                                      toastLength: Toast.LENGTH_SHORT,
                                    );
                                  }
                                } else {
                                  Fluttertoast.showToast(
                                      msg: "Choose an account type");
                                }
                              }
                            },
                          ),
